    ...
    return (
        <Layout title="Núcleos" description="Un núcleo es una unidad de procesamiento dentro del microprocesador capaz de ejecutar instrucciones de forma independiente. ">
            <div className="grid-c-2">
                <Image width={1000} height={1000} className='max-width p-20' src='https://www.muycomputer.com/wp-content/uploads/2019/01/Sandy-Bridge.jpg' alt='núcleos' />
                <div>
                    <h1>Núcleos</h1>
            ...
            <div className='mt-50 center-text'>
                <Link className='f-size-30 bg-blue white-text p-20 radius-30' href='/projects/arquitectura-de-computadoras/memoria-cache'>Continuar</Link>
            </div>
        </Layout>
    )
}
