    ...
    return (
        ...
        {/* <Layout title='GPU' description='La GPU es una unidad especializada en el procesamiento de gráficos y visualización.'> */}
            <div className="grid-c-2 gap-25">
                <Image width={1000} height={1000} className='max-width p-10' src='https://www.digitaltrends.com/wp-content/uploads/2021/12/graphics-card-gpu-feature-image-shutterstock-3.jpg?p=1' alt='gpu' />
                <div>
            ...
            <div className='mt-50 center-text'>
                <Link className='f-size-22 bg-blue white-text p-20 radius-30' href='/projects/arquitectura-de-computadoras/alu'>Continuar</Link>
            </div>
        {/* </Layout> */}
        </>
    )
