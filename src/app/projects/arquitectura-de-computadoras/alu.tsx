    ...
    return (
        <Layout title='ALU' description='La ALU es una parte fundamental del microprocesador que realiza operaciones aritméticas y lógicas. '>
            <div className="grid-c-2">
                <Image width={1000} height={1000} className='max-width p-20' src='https://ars.els-cdn.com/content/image/3-s2.0-B9780323313025000053-f05-03-9780323313025.jpg' alt='alu' />
                <div>
            ...
            <div className='mt-50 center-text'>
                <Link className='f-size-30 bg-blue white-text p-20 radius-30' href='/projects/arquitectura-de-computadoras/gpu'>Continuar</Link>
            </div>
        </Layout>
    )
}
