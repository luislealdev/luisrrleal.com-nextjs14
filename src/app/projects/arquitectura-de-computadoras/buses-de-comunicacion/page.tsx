...
const BusesDeComunicacionPage = () => {
    ...
    return (
        <>
            ...
            <div className='grid-c-2 justify-text gap-25'>
                <Image width={1000} height={1000} className='max-width p-10' src='https://www.emagister.com/blog/wp-content/uploads/2021/12/pexels-pixabay-50711.jpg' alt='buses de comunicación' />
                <div>
                    <h1>
            ...
            <div className='mt-50 mb-50 center-text'>
                <Link className='f-size-22 bg-blue white-text p-20 radius-30' href='/projects/arquitectura-de-computadoras/nucleos'>Continuar</Link>
            </div>
            {/* </Layout> */}
        </>
    )
